 ...
 * </ol>
 *
 * copy form MyBatisGenerator 解决mapper文件没有注释
 * @author Jeff Butler
...
public class MyBatisGeneratorPlus {
     ...
     */
    public MyBatisGeneratorPlus(Configuration configuration, ShellCallback shellCallback,
    ...
    private void writeFile(File file, String content, String fileEncoding) throws IOException {
        ...
        if (file.getName().endsWith("Mapper.java")) {
            content = content.replaceFirst("public interface", "/**\n" +
