...
import com.shaw.lts.core.exception.JacksonException;
...
public class JacksonUtils {
    ...
    static {
        try {
            ...
            throw new  RuntimeException("jackson config error");
        }
    }
...
//        objectMapper.registerModule(new GuavaModule());
     ...
     * JSON反序列化
     */
    public static <V> V toObject(URL url, Class<V> type) {
        try {
     ...
     * JSON反序列化
     */
    public static <V> V toObject(URL url, TypeReference<V> type) {
        try {
            return mapper.readValue(url, type);
        } catch (IOException e) {
            throw new JacksonException("jackson from error, url: {}, type: {}", url.getPath(), type, e);
     ...
     * JSON反序列化（List）
     */
    public static <V> List<V> toArray(URL url, Class<V> type) {
        try {
     ...
     * JSON反序列化
     */
    public static <V> V toObject(InputStream inputStream, Class<V> type) {
        try {
     ...
     * JSON反序列化
     */
    public static <V> V toObject(InputStream inputStream, TypeReference<V> type) {
        try {
            return mapper.readValue(inputStream, type);
        } catch (IOException e) {
            throw new JacksonException("jackson from error, type: {}", type, e);
     ...
     * JSON反序列化（List）
     */
    public static <V> List<V> toArray(InputStream inputStream, Class<V> type) {
        try {
            CollectionType collectionType = mapper.getTypeFactory().constructCollectionType(ArrayList.class, type);
     ...
     * JSON反序列化
     */
    public static <V> V toObject(File file, Class<V> type) {
        try {
     ...
     * JSON反序列化
     */
    public static <V> V toObject(File file, TypeReference<V> type) {
        try {
            return mapper.readValue(file, type);
        } catch (IOException e) {
            throw new JacksonException("jackson from error, file path: {}, type: {}", file.getPath(), type, e);
     ...
     * JSON反序列化（List）
     */
    public static <V> List<V> toArray(File file, Class<V> type) {
        try {
            CollectionType collectionType = mapper.getTypeFactory().constructCollectionType(ArrayList.class, type);
     ...
     * JSON反序列化
     */
    public static <V> V toObject(String json, Class<V> type) {
     ...
     * JSON反序列化
     */
    public static <V> V toObject(String json, TypeReference<V> type) {
        return toObject(json, type.getType());
    }

    /**
     * JSON反序列化
     */
    public static <V> V toObject(String json, Type type) {
     ...
     * JSON反序列化（List）
     */
    public static <V> List<V> toArray(String json, Class<V> type) {
        if (StringUtils.isEmpty(json)) {
            return null;
        }
        try {
    ...
    public static int getInt(String json, String key) {
        ...
        try {
            ...
            return jsonNode.isInt() ? jsonNode.intValue() : Integer.parseInt(getString(jsonNode));
        } catch (Exception e) {
    ...
    public static long getLong(String json, String key) {
        ...
        try {
            ...
            return jsonNode.isLong() ? jsonNode.longValue() : Long.parseLong(getString(jsonNode));
        } catch (Exception e) {
    ...
    public static double getDouble(String json, String key) {
        ...
        try {
            ...
            return jsonNode.isDouble() ? jsonNode.doubleValue() : Double.parseDouble(getString(jsonNode));
        } catch (Exception e) {
    ...
    public static BigInteger getBigInteger(String json, String key) {
        ...
        try {
            ...
            return jsonNode.isBigInteger() ? jsonNode.bigIntegerValue() : new BigInteger(getString(jsonNode));
        } catch (Exception e) {
    ...
    public static BigDecimal getBigDecimal(String json, String key) {
        ...
        try {
            ...
            return jsonNode.isBigDecimal() ? jsonNode.decimalValue() : new BigDecimal(getString(jsonNode));
        } catch (Exception e) {
    ...
    public static byte[] getBytes(String json, String key) {
        ...
        try {
            ...
            return jsonNode.isBinary() ? jsonNode.binaryValue() : getString(jsonNode).getBytes();
        } catch (Exception e) {
    ...
    public static <V> V getObject(String json, String key, Class<V> type) {
        ...
        try {
            ...
            JavaType javaType = mapper.getTypeFactory().constructType(type);
            return toObject(getString(jsonNode), javaType);
        } catch (Exception e) {
    ...
    public static <V> List<V> getList(String json, String key, Class<V> type) {
        ...
        try {
            ...
            CollectionType collectionType = mapper.getTypeFactory().constructCollectionType(ArrayList.class, type);
            return toObject(getString(jsonNode), collectionType);
        } catch (Exception e) {
            throw new JacksonException("jackson get list error, json: {}, key: {}, type: {}", json, key, type, e);
        }
    }
